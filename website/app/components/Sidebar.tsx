...
export default function Sidebar() {
  ...
  const authNavItemsMain = [
    ...
    { href: "https://docs.loglife.co/", icon: (<svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>), label: "Docs", external: true },
          ...
          {isSignedIn ? (
            <>
              {authNavItemsMain.map((item, index) => 
                item.external ? (
                  <a key={index} href={item.href} target="_blank" rel="noopener noreferrer" className="h-9 flex items-center gap-2 px-2 sm:px-3 rounded-lg transition-colors text-slate-400 hover:text-emerald-400 hover:bg-emerald-500/10">
                    {item.icon}
