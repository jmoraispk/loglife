...
export default function DashboardPage() {
  ...
  const [selectedService, setSelectedService] = useState<"whatsapp" | "telegram">("whatsapp");
  const [phoneNumber, setPhoneNumber] = useState("");
  const [sendingMessage, setSendingMessage] = useState(false);
  const [sendMessageFeedback, setSendMessageFeedback] = useState<string | null>(null);
        ...
        {sessionLoading ? (
          ...
          <div className="space-y-8">
            ...
            <div className="text-center max-w-xl mx-auto">
              <h2 className="text-3xl font-bold text-white tracking-tight">Start logging now.</h2>
              <p className="text-sm text-slate-400 mt-2">Connect your WhatsApp to begin journaling with LogLife.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="order-2 md:order-1 bg-slate-900/50 border border-slate-800/50 rounded-xl p-6 flex flex-col">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-white">Message the AI</h3>
                    <p className="text-xs text-slate-500">Start journaling right away</p>
                  </div>
                </div>
                ...
                <div className="mt-4 flex-1 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) => setSelectedService(e.target.value as "whatsapp" | "telegram")}
                        className="w-full appearance-none rounded-lg bg-slate-950/50 border border-slate-700/50 text-sm text-white px-3 py-2.5 pr-8 focus:outline-none focus:ring-1 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all cursor-pointer"
                      >
                        <option value="whatsapp">WhatsApp</option>
                        <option value="telegram" disabled>Telegram (coming soon)</option>
                      </select>
                      <svg className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href="https://wa.me/15550000000?text=start"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center gap-3.5 rounded-xl bg-[#25D366]/10 border border-[#25D366]/25 hover:border-[#25D366]/50 hover:bg-[#25D366]/15 p-4 transition-all cursor-pointer active:scale-[0.98]"
                  >
                    <div className="w-10 h-10 rounded-full bg-[#25D366]/20 group-hover:bg-[#25D366]/30 flex items-center justify-center flex-shrink-0 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <span className="block text-sm font-semibold text-white group-hover:text-[#25D366] transition-colors">
                        Send &quot;start&quot; to +1&nbsp;(555)&nbsp;000-0000
                      </span>
                      <span className="block text-xs text-slate-500 mt-0.5">
                        Tap to open WhatsApp automatically
                      </span>
                    </div>
                    <svg className="w-4 h-4 text-slate-600 group-hover:text-[#25D366] group-hover:translate-x-0.5 transition-all flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-xs text-slate-500 mt-4">
                  To connect your dashboard, go to{" "}
                  <Link href="/account" className="text-emerald-400 hover:underline">Account Settings</Link>{" "}
                  after your first message.
                </p>
              </div>

              {/* Right Card — "We message you" (Recommended) */}
              <div className="order-1 md:order-2 relative bg-slate-900/50 border border-emerald-500/40 rounded-xl p-6 flex flex-col shadow-[0_0_25px_rgba(16,185,129,0.08)]">
                {/* Recommended Badge */}
                ...
                <div className="flex items-center gap-3 mb-1 mt-2">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-white">Get messaged by LogLife</h3>
                    <p className="text-xs text-emerald-400/70">Fastest way to get started</p>
                  </div>
                </div>
                ...
                <div className="mt-4 flex-1 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1.5">Include your country code (e.g. 1 for US)</p>
                  </div>
                  ...
                  <div className="rounded-lg bg-emerald-500/5 border border-emerald-500/15 p-4">
                    <div className="flex items-start gap-2.5">
                      ...
                      <p className="text-xs text-slate-400">
                        We&apos;ll send you a WhatsApp message and <span className="text-emerald-400">connect your dashboard automatically</span> &mdash; no extra steps needed.
                      </p>
                    </div>
                  </div>

                  {sendMessageFeedback && (
                    <div className="px-3 py-2 rounded-lg text-xs bg-amber-500/10 text-amber-400 border border-amber-500/20">
                      {sendMessageFeedback}
                    </div>
                  )}
                  ...
                  <button
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        ...
                        setSendMessageFeedback("This feature is coming soon. Use the left option for now.");
                      }, 800);
                    }}
                    disabled={!phoneNumber.trim() || sendingMessage}
            ...
            <p className="text-center text-xs text-slate-500">
              ...
              <Link href="/account" className="text-emerald-400 hover:underline">
                Connect manually in Account Settings
              </Link>
            </p>
          </div>
        ) : (
