    ...
    <main className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://wa.me/17155157761?text=help" className="inline-flex items-center justify-center px-8 py-4 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 transition-all shadow-lg hover:shadow-xl">
      ...
      <section id="final-cta" className="py-20 bg-gradient-to-br from-emerald-500 to-emerald-700">
        <div className="container mx-auto px-12 text-center">
          ...
          <a href="https://wa.me/17155157761?text=help" className="inline-flex items-center px-10 py-5 bg-white text-emerald-700 rounded-2xl font-bold text-lg hover:bg-emerald-50 transition-all shadow-2xl hover:shadow-3xl mb-8">
