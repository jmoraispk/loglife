      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        <div className="bg-gradient-to-br from-emerald-500/10 to-slate-900/50 border border-emerald-500/20 rounded-3xl p-12 text-center">
          ...
          <div className="flex justify-center gap-3 mb-6">
            <button
              onClick={openWidget}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#25D366]/10 border border-[#25D366]/30 text-[#25D366] text-sm font-medium hover:bg-[#25D366]/20 transition-colors cursor-pointer"
            >
