  ...
  return (
    <main className="min-h-screen pt-32 pb-24 px-6 lg:px-8">
      <div className="relative z-10 mx-auto max-w-6xl">
            ...
            <div className="bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Full control, you do the work</p>
                </div>
              </div>

              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-slate-300">~2&ndash;4 hours</span>
                <p className="text-sm text-slate-500 mt-1">to get up and running</p>
              </div>

              <div className="space-y-3">
                {[
                  "Set up a VPS or local server",
                  "Configure 5 API keys (OpenAI, Anthropic, Whisper, etc.)",
                  "Deploy via Docker",
            ...
            <div className="bg-slate-900/60 backdrop-blur-md border-2 border-emerald-500/40 rounded-2xl p-8 shadow-lg shadow-emerald-500/10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-400">You just chat. We handle the rest.</p>
                </div>
              </div>

              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-emerald-400">~5 minutes</span>
                <p className="text-sm text-slate-500 mt-1">to start chatting</p>
              </div>

              <div className="space-y-3">
                {[
                  "All 5 API keys configured for you",
                  "Private cloud instance provisioned",
                  "Cloud storage and backups included",
        ...
        {/* Pricing Cards */}
        <div className="grid lg:grid-cols-2 gap-6 items-start max-w-4xl mx-auto animate-slide-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="p-8 flex flex-col flex-1">
              <div className="mb-8">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-slate-600 font-medium line-through">$19/mo</span>
                </div>
              </div>
        ...
        <div className="mt-24 animate-slide-up" style={{ animationDelay: "0.3s" }}>
          <div className="text-center mb-12">
            <span className="text-emerald-400 tracking-widest text-sm font-semibold uppercase">What&apos;s Included</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-white mt-3 mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "API Keys",
                description: "5 provider keys (LLM, speech, embeddings, etc.) configured and managed. No BYO hassle unless you want it.",
                icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z",
              },
              {
                title: "Infrastructure",
                description: "Private cloud instance, storage, monitoring, alerts. Always running, always updated.",
                icon: "M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01",
              },
              {
                title: "Updates",
                description: "New features, security patches, model upgrades\u2014deployed automatically. You never touch a terminal.",
                icon: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12",
              },
              {
                title: "Support",
                description: "Email support, onboarding help, and community access. We want you to succeed.",
                icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="bg-slate-900/40 backdrop-blur-md border border-slate-800 rounded-2xl p-6 hover:border-emerald-500/30 transition-all duration-200"
              >
        ...
        <div className="mt-24 text-center animate-slide-up" style={{ animationDelay: "0.6s" }}>
          <div className="bg-gradient-to-br from-emerald-500/10 to-slate-900/50 border border-emerald-500/20 rounded-3xl p-12">
            ...
            <p className="text-lg text-slate-400 mb-8">Early access is free. No card needed. Cancel anytime.</p>
            <button
              onClick={openWidget}
