...
function CallPageContent() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden flex items-center justify-center transition-colors duration-300">
      ...
      <div className="absolute inset-0 w-full h-full -z-10 transition-colors duration-300 bg-transparent" />

      <div className="flex flex-col items-center text-center px-6 py-12">
        {/* Minimal heading */}
        <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight mb-12 transition-colors duration-300 text-slate-300">
          Talk to your LogLife
        </h1>

        {/* Configuration Error */}
        {configError && (
          <div className="mb-6 p-4 rounded-lg max-w-md bg-red-900/20 border border-red-800">
        ...
        <div className="flex flex-col items-center gap-6">
          {isCallActive ? (
            <button
              ...
              className="group relative inline-flex items-center justify-center gap-4 px-12 py-6 sm:px-16 sm:py-8 rounded-2xl font-semibold text-lg sm:text-xl transition-all duration-300 shadow-2xl hover:scale-105 active:scale-95 cursor-pointer bg-red-600 hover:bg-red-500 text-white shadow-red-600/50"
            >
              ...
              <span>End Call</span>
              {/* Subtle glow effect */}
              <div className="absolute inset-0 rounded-2xl blur-xl opacity-50 -z-10 transition-opacity duration-300 bg-red-500" />
            </button>
          ) : isConnecting ? (
            <button
              onClick={handleEndCall}
              className="group relative inline-flex items-center justify-center gap-4 px-12 py-6 sm:px-16 sm:py-8 rounded-2xl font-semibold text-lg sm:text-xl transition-all duration-300 shadow-2xl hover:scale-105 active:scale-95 cursor-pointer bg-emerald-600 hover:bg-emerald-500 text-white shadow-emerald-600/50"
            >
              ...
              {/* Subtle glow effect */}
              <div className="absolute inset-0 rounded-2xl blur-xl opacity-50 -z-10 transition-opacity duration-300 bg-emerald-500" />
            </button>
          ) : (
            <button
          ...
          {isConnecting && (
            <p className="text-sm transition-colors duration-300 text-emerald-400">
