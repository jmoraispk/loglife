...
<Columns cols={2}>
  <Card title="Development" icon="code" href="/development">
    Local development workflow and CI/CD pipelines.
  </Card>
  <Card title="Security" icon="shield" href="/security">
    Authentication, phone verification, and data flow.
  </Card>
  <Card title="OpenClaw tricks" icon="wand-magic-sparkles" href="/openclaw-tricks">
    Useful tips for managing your OpenClaw instance.
  </Card>
  <Card title="API reference" icon="terminal" href="/api-reference/introduction">
    Plugin HTTP endpoints documentation.
  </Card>
</Columns>
