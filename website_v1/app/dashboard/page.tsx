      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-slate-900/50 border border-slate-800/50 rounded-xl p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-slate-500 uppercase tracking-wide">This Week&apos;s Streak</p>
                <p className="text-2xl font-semibold text-white mt-1">0</p>
              </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800/50 rounded-xl p-4">
            ...
            <p className="text-xs text-slate-500 mt-2">AI-surfaced moments</p>
          </div>
          ...
          <div className="lg:col-span-2 bg-slate-900/50 border border-slate-800/50 rounded-xl">
            ...
            <div className="p-5">
              <div className="text-center py-12">
                ...
                <p className="text-sm text-slate-400 mb-1">No journal entries yet</p>
                <p className="text-xs text-slate-500">Start your first journal entry to get started</p>
              </div>
            </div>
          </div>
            ...
            <div className="p-3">
              <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-slate-400 hover:bg-slate-800/50 hover:text-white transition-all cursor-pointer text-left">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Start a new entry via chat</p>
                </div>
              </button>
              ...
              <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-slate-400 hover:bg-slate-800/50 hover:text-white transition-all cursor-pointer text-left">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">D/W/M/Q/Y highlights</p>
                </div>
              </button>
              ...
              <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-slate-400 hover:bg-slate-800/50 hover:text-white transition-all cursor-pointer text-left">
                ...
                <div>
                  <p className="text-sm text-slate-300">View Insights</p>
                  <p className="text-xs text-slate-500">Patterns and analytics</p>
                </div>
              </button>
