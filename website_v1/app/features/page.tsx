...
// Integrations data (replaces old "Skills")
const integrations = [
  { name: "Oura Ring", category: "Health", description: "Sleep, activity, readiness scores" },
  { name: "Calendar", category: "Productivity", description: "Schedule and track events" },
  ...
  { name: "Reminders", category: "Productivity", description: "Habit reminders and nudges" },
  { name: "Photos", category: "Memory", description: "Attach photos to journal entries" },
];
...
const platformFeatures = [
  {
    title: "Voice & Speech",
    description: "Record voice notes, get instant transcription, and search through everything you've ever said",
    icon: (
  ...
  },
  {
    ...
    description: "Entities, links, and patterns extracted from your life data — connections you never saw",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Integrate health wearables and productivity tools — Oura, Apple Health, Calendar, and more",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Gentle nudges to journal, review, and reflect — never forget to check in with yourself",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "AI Memory",
    description: "Long-term context that grows with you — the more you share, the more it understands",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="text-center mb-20 animate-slide-up">
          <h1 className="text-4xl lg:text-6xl font-bold text-white tracking-tight mb-6">
            Built for <span className="text-emerald-500">your life</span>
          </h1>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
            LogLife brings voice logging, multi-channel support, and AI-powered insights 
            so you can capture your journey and see patterns — wherever you already chat.
          </p>
        </div>
        ...
        <section className="mb-24 animate-slide-up" style={{ animationDelay: "0.1s" }}>
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-400">Journal from anywhere — no app to download</p>
            </div>
          ...
          <p className="mt-6 text-sm text-slate-500 text-center">
            + phone calls and more channels coming soon
          </p>
        </section>

        {/* Integrations Section (was Skills) */}
        <section className="mb-24 animate-slide-up" style={{ animationDelay: "0.2s" }}>
          <div className="mb-8">
            ...
            <p className="text-slate-400">Connect wearables, apps, and tools to enrich your life data automatically</p>
          </div>
          ...
          <p className="mt-6 text-sm text-slate-500 text-center">
            + more integrations coming: Strava, Google Fit, Garmin, and more
          </p>
        </section>
        ...
        <section className="animate-slide-up" style={{ animationDelay: "0.4s" }}>
          <div className="bg-gradient-to-br from-emerald-500/10 to-slate-900/50 border border-emerald-500/20 rounded-3xl p-8 md:p-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                { title: "No App Needed", description: "Works through chat platforms you already use. Zero friction.", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
                { title: "AI Highlights", description: "3-5 most important moments, automatically surfaced at every time scale.", icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" },
                { title: "Life Dashboard", description: "Visualize your journey with charts, patterns, and progress over time.", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
                { title: "Privacy First", description: "Open source, self-hostable, encryption built-in. Your data stays yours.", icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" },
                { title: "Always Growing", description: "AI memory that deepens the more you share. It gets you.", icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
              ].map((item, index) => (
