...
export const metadata: Metadata = {
  title: "LogLife — Chat-Native AI Journaling",
  description:
    "Audio-first, chat-native journaling powered by AI. Track your progress, find patterns, and build better habits — all through the chat apps you already use. No app to download. Your data stays yours.",
};
