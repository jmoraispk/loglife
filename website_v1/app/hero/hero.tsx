        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-xl lg:text-2xl text-slate-300 leading-relaxed animate-slide-up" style={{ animationDelay: "0.1s" }}>
              Chat-native AI journaling. Talk about your day, and watch your life story unfold — daily, weekly, monthly, yearly highlights, all from a simple conversation.
            </p>
  ...
  const features = [
    {
      ...
      title: "Chat-Native",
      description: "No app to download. Journal through WhatsApp, Telegram, or any chat platform you already use."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Record thoughts with a quick voice note. AI transcribes, tags, and organizes everything."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Your 3-5 most important moments — surfaced daily, weekly, monthly, quarterly, and yearly."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Open source, self-hostable. Your data stays yours. Export or delete anytime."
    }
  ];
    ...
    <section id="features" className="relative py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-400">Simple, powerful tools for capturing and reflecting on your life</p>
        </div>
  ...
  const steps = [
    {
      ...
      description: "Send a voice note or text about your day through your favorite chat app.",
      icon: (
    ...
    },
    {
      ...
      description: "LogLife transcribes, tags, and organizes your entries automatically.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
        </svg>
    ...
    },
    {
      ...
      description: "AI surfaces the 3-5 most important things from your day, week, month.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Visualize patterns, track habits, and see your progress over time.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
        </svg>
    ...
    },
    {
      number: "5",
      title: "Ask anything",
      description: "Query your life data in plain language: \"How was my sleep last week?\"",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="how-it-works" className="relative py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-400">From conversation to life story in five simple steps</p>
        </div>
    ...
    <section id="comparison" className="relative py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-400">Nobody can tell you what they did last Tuesday. Isn&apos;t that unbelievable?</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-slate-400 mb-6 flex items-center gap-2">
              <span className="text-emerald-400">&#10007;</span> The old way
            </h3>
            <ul className="space-y-4">
              {[
                ...
                "Can't remember what you did last week",
                "Data locked in silos you never revisit",
                "No system — just memory, which is lossy"
              ].map((item, i) => (
          ...
          <div className="bg-slate-900/60 backdrop-blur-md border border-emerald-500/30 rounded-2xl p-8 shadow-lg shadow-emerald-500/10">
            ...
            <ul className="space-y-4">
              {[
                "One place for voice notes, habits, and reflections",
                "AI-surfaced highlights keep goals vivid and alive",
                "Patterns emerge: sleep → mood → productivity",
                "Log in seconds — just talk through your chat app",
                "Automatic transcription, tagging, and search",
                "Your D/W/M/Q/Y timeline at a glance",
                "All your data in one place, export anytime",
                "Ask anything: \"How many on-time bedtimes last week?\""
              ].map((item, i) => (
